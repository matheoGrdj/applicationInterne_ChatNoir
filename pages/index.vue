...
<template>
    <div class="min-h-screen bg-gray-100 py-8 px-4">
        ...
        <div class="text-center mb-10">
            <button
                class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-full shadow-lg transform transition-transform hover:scale-105">
                Ajouter une image
            </button>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div v-for="image in images" :key="image.id"
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center">
                        <div class="w-48 h-48 overflow-hidden rounded-md mb-4">
